...
// ==========================================
// 1. CONSTANTES E PLANO DE CLASSIFICAÇÃO
// ==========================================
const CATEGORIES = {
        ...
        <div className="flex-1 overflow-y-auto px-1 space-y-4 pb-10">
          <div className="flex gap-4">
            ...
            <div className="flex flex-col flex-1 justify-center">
              ...
              {selectedItem.archive_code && (
                <div className={`text-[9px] font-mono font-black uppercase tracking-widest mb-2 border-[2px] w-max px-1.5 py-0.5 ${darkMode ? 'border-gray-500 text-gray-300' : 'border-black text-black'}`}>
                  {selectedItem.archive_code}
                </div>
              )}
...
const AddTab = ({ items, setItems, settings, darkMode, addMode, setAddMode, setActiveTab }) => {
  ...
  const handleSave = () => {
    ...
    // Geração da Etiqueta Arquivística Sequencial
    ...
    // Envio Transparente para o Google Sheets (Webhook)
    if (settings.googleSheetsUrl) {
      ...
      }).catch(err => console.error("Erro no envio para o Sheets", err));
    }
